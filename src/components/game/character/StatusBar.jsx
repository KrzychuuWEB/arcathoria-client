...
const StatusBar = ({value, maxValue, variant, xpNeeded, experience}) => {
    ...
    const {className, label} = variants[variant] || {className: "bg-gray-500", label: "Unknown"};

    return (
        <div
            className="relative w-full h-[10px] bg-black rounded-sm flex items-center px-2 text-white text-[10px] font-bold">
